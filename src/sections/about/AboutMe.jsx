  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-primary text-lg sm:text-xl md:text-2xl mb-12 pl-4 border-l-4 border-chart-2"
      >
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col gap-6 bg-sidebar-foreground rounded-2xl py-4 sm:py-6 shadow-sm overflow-hidden"
          >
